...
const CustomCarousal = ({ carousalItems }) => {
  ...
  const handlecarousalAutoIndexUpdate = () => {
    setInterval(() => {
      // while (carousalCurrentIndex < carousalItems.length) {
      //   setTimeout(() => {
      //     setCarousalCurrentIndex(carousalCurrentIndex + 1);
      //   })
      // })
  }, 3000)
}
  , 3000 * carousalItems.length)
}
